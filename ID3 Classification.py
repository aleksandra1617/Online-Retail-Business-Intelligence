# For the report on the section which asks to describe the process just write pseudo code
# # no need for annotated screenshots!
# # With every level of the tree the data gets smaller and smaller.
# NEXT STEPS
...
#      2) https://sefiks.com/2017/11/20/a-step-by-step-id3-decision-tree-example/                                 #
#                                                                                                                 #
...
#                                                                                                                 #
# 3) KEY WORDS USED                                                                                               #
#    Decision Node: Indicates a decision to be made. Example nodes are Grade, Surface and Speed Limit.            #
#    Chance Node: Shows multiple uncertain outcomes. Example nodes are Slow, Yes, Bumpy, Steep, etc.              #
#                                                                                                                 #
...
class ID3DecisionTree:
    def __init__(self):
        ...
        # TODO: Merget this list with the active_branch_nodes to be in dictionary format like so
